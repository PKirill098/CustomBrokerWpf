...
{
    /// <summary>
    /// Логика взаимодействия для ForwarderWin.xaml
    /// </summary>
    public partial class ForwarderWin : Window
    {
        public ForwarderWin()
        {
            InitializeComponent();
        ...
        private void DataLoad()
        {
            try
            {
                ...
                KirillPolyanskiy.CustomBrokerWpf.ReferenceDSTableAdapters.ForwarderAdapter thisAdapter = new KirillPolyanskiy.CustomBrokerWpf.ReferenceDSTableAdapters.ForwarderAdapter();
                thisAdapter.ClearBeforeFill = false;
                thisAdapter.Fill(thisDS.tableForwarder);
                this.mainDataGrid.ItemsSource = thisDS.tableForwarder.DefaultView;
            }
            catch (Exception ex)
            {
        ...
        private bool SaveChanges()
        {
            ...
            try
            {
                ...
                KirillPolyanskiy.CustomBrokerWpf.ReferenceDS thisDS = ((KirillPolyanskiy.CustomBrokerWpf.ReferenceDS)(this.FindResource("keyReferenceDS")));
                KirillPolyanskiy.CustomBrokerWpf.ReferenceDSTableAdapters.ForwarderAdapter thisAdapter = new KirillPolyanskiy.CustomBrokerWpf.ReferenceDSTableAdapters.ForwarderAdapter();
                thisAdapter.Update(thisDS.tableForwarder);
                isSuccess = true;
            }
            catch (Exception ex)
            {
