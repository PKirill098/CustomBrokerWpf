...
namespace KirillPolyanskiy.CustomBrokerWpf
{
    ...
    internal class ParcelRequestConflictResolution
    {
        ...
        private void Resolve()
        {
            ...
            PropertyConcurrencyManager<int?> statusres = new PropertyConcurrencyManager<int?>("Status", "Статус", rq.Status.Id, myrow.Field<int?>("statusId", DataRowVersion.Original), myrow.Field<int?>("statusId", DataRowVersion.Current), new Func<int?, int?, bool>((int? ser, int? cur) =>{ return (PropertyConcurrencyManager<int?>.CheckEquals(ser, cur) || (((ser == 30 & !rq.SpecificationIsNull) | ser == 40) & cur == 50) | (ser < 50 & ser != 20 & cur == 40)); }));
