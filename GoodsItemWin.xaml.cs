...
{
    /// <summary>
    /// Interaction logic for GoodsItemWin.xaml
    /// </summary>
    public partial class GoodsItemWin : Window
    {
        public GoodsItemWin()
        {
            InitializeComponent();
        ...
        {
            Classes.Domain.GoodsCommand cmd = this.DataContext as Classes.Domain.GoodsCommand;
