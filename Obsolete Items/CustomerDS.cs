...
namespace KirillPolyanskiy.CustomBrokerWpf
{
    ...
    {
        partial class tableCustomerContactPointDataTable
        {
            ...
            private void PointColumnChangeEvent(object sender, System.Data.DataColumnChangeEventArgs e)
            {
                ...
                {
                    CustomerDS.tableCustomerContactPointRow row = e.Row as CustomerDS.tableCustomerContactPointRow;
                    ...
                    else if (!isUpdatedPointName & e.Column.ColumnName == "PointValue" & !row.IsPointNameNull())
                        e.ProposedValue = ConvertPointValue(row.PointName, e.ProposedValue.ToString());
                }
            }
